...
if __name__ == '__main__':
    ...
    for message in foo:
        ...
        print('message.partition: ' + str(message.partition))
        print('message.offset: ' + str(message.offset))
        print('message.key: ' + str(message.key))
        print('message.value: ' + str(message.value))
